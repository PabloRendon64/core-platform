...
import com.inditex.core.platform.BaseTest;
...
import static com.inditex.core.platform.domain.usecase.SearchPrice.SEARCH_PRICE_NOT_FOUND_RESULTS;
...
public class SearchPriceTest extends BaseTest {
    ...
    void givenBrandIdAndProductIdAndQueryDateThenReturnPriceResult() {
        ...
        //when
        when(priceRepository.searchByBrandIdAndProductIdAndQueryDateTime(any(OffsetDateTime.class), anyLong(), anyLong()))
