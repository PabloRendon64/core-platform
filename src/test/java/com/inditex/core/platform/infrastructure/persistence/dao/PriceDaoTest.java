...
import static com.inditex.core.platform.BaseTest.*;
...
public class PriceDaoTest {
    ...
    @BeforeEach
    public void setup() {
        priceRepository = new PriceDao(priceJpaRepository, mapper);
    }
    ...
    void givenBrandIdAndProductIdAndQueryDateAndDependenciesWorksThenReturnPriceList() {
        ...
        //then
        var result = priceRepository.searchByBrandIdAndProductIdAndQueryDateTime(queryDateTime, productId, brandId);
